<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayrollApproval.aspx.cs" Inherits="HRIS_Basic.PayrollApproval" %>
    ...
    <body>
        <form action="#" autocomplete="off" runat="server">
                ...
                <nav id="nav">
                    <div class="logo">
                        <a href="home.html" class="logo-link">
                            <h1>LOGO HERE</h1>
                            <p>
                                HRIS, Payroll & Time Keeping System
                            </p>
                        </a>
                    </div>
            ...
            <li>
              ...
              ></a>
                            <ul class="nav child_menu hidden">
                                ...
                                <li>
                                    <a href="TimeAlterationApproval.aspx">Time Alteration Approval</a
                  >
                </li>
                 <li>
            ...
            ></a>
                                ...
                                <li>
                                    <a href="UnderConstructionAdmin.aspx"><i class="fas fa-list"></i>Employee Assignment</a
              >
            </li>
            <li>
              <a href="#"
          ...
          <div class="close-menu">
            ...
            <!-- Payroll Approval -->
            <section id="payroll-approval" class="content">
                <!-- TOP NAV  -->
                <div class="top-nav">
                    <span class="menu-btn">
                ...
                <div class="container">
                    ...
                    <div class="card card-1">
                        ...
                        <table class="tableLayout">
                            <asp:DataGrid ID="dgPayrollApproval" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                <Columns>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Pay Period" DataField="PAYPERIOD" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee" DataField="Employee" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Net Pay" DataField="NetPay" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    <asp:TemplateColumn HeaderText="ACTION" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="btn-circle-container" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnCancel" runat="server" CssClass="fas fa-check btn-circle btn-green" CommandArgument=<%# Eval( "Payroll_ID") %> CommandName="Approve" OnCommand="itemcommand">
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="fas fa-times btn-circle btn-red" CommandArgument=<%# Eval( "Payroll_ID") %> CommandName="Reject" OnCommand="itemcommand"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                </Columns>
                            </asp:DataGrid>
               ...
               <%-- <div class="pagination" onclick="selectPage()">
                ...
                <div class="modal modal-with-pay">
                    <div class="modal-content">
                        ...
                        <hr />
                        <input type="checkbox" id="chkWithPay" />
                        <label class="label-5" for="chkWithPay">With Pay</label>

                        <div class="modal-btn-container">
                            <a class="btn-sm btn-primary mx-3">Approve</a>
          ...
          <div class="modal modal-leave-remarks">
            <div class="modal-content">
              <p class="notif notif-red">Not Enough Available Leave Credit</p>
              <label class="label-6" for="modalRemarksTA">Remarks</label>
              <textarea name="modalRemarksTA" id="modalRemarksTA"></textarea>

              <div class="modal-btn-container">
                <a class="btn-sm btn-primary mx-3">Okay</a>
                            <a class="btn-sm btn-secondary mx-3" onclick="closeModalLeaveRemarks();">Cancel</a
                >
              </div>
            </div>
          </div>
