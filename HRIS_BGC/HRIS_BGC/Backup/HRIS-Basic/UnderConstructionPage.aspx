<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnderConstructionPage.aspx.cs" Inherits="HRIS_Basic.UnderConstrucionPage" %>
      ...
      <nav id="nav">
        ...
        <div class="profile">
         ...
         <!-- / menu -->
            ...
            <!-- Underconstruction -->
      <section id="underconstruction" class="content">
        <!-- TOP NAV  -->
        <div class="top-nav">
          <span class="menu-btn">
