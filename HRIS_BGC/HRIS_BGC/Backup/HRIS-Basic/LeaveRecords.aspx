<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveRecords.aspx.cs" Inherits="HRIS_Basic.LeaveRecords" %>
...
<body>
    <form action="#" autocomplete="off" runat="server">
        ...
        <div class="main">
            ...
            <!-- Leave Records -->
            <section id="leaverecords" class="content">
                <!-- TOP NAV  -->
                <div class="top-nav">
                    <span class="menu-btn">
              <a href="#" onclick="toggleMenu()">
                    ...
                    <div id="tab">
                      <ul class="tab-list" onclick="selectTab();">
                        <li class="current-tab"> 
                          <a onclick="showLR();">Leave Records</a>
                        </li>
                        <li>
                          <a  onclick="showPLA();">Pending Leaves</a>
                        </li>
                      </ul>
                    </div>
                    <div class="card card-1">
                        <div class="card-subhead-container">
                            <div class="card-subhead">
                                ...
                                <label class="text px-2" id="availableSLeave" runat="server">0</label>
                                <label class="text px-2" id="usedSLeave" runat="server">0</label>
                                <label class="text px-2" id="remainingSLeave" runat="server">0</label>

                                <label class="label-6 block">Vacation/Emergency leave</label>
                                <label class="label-6 px-2">Available:</label>
                                <label class="label-6 px-2">Used:</label>
                                <label class="label-6 px-2">Remaining:</label>
                                <label class="text px-2" id="availableVELeave" runat="server">0</label>
                                <label class="text px-2" id="usedVELeave" runat="server">0</label>
                                <label class="text px-2" id="remainingVELeave" runat="server">0</label>
                            </div>

                            <div class="">
                                <a class="btn-sm btn-primary" id="btnFileLeave" runat="server" onclick="openModal(`#btnFileLeave`);">
                    File a leave
                  </a>
                            </div>
                        </div>

                        <label class="label-6 block">Show record status</label>
                        <select name="showEmployeeBy" id="showEmployeeBy" class="select" onchange="">
                            <option value="">All</option>
                            <option value="department">Approved</option>
                            <option value="position">Rejected</option>
                        </select>
                    ...
                    <div class="card card-2 hidden">
                        ...
                        <div class="container-sm">
                            ...
                            <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Pending Records Available" Visible="false"></asp:Label>
                             <table class="tableLayout">
                                    <asp:DataGrid ID="dgPendingLeave" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout"
                                        CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center"
                                        AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <ItemTemplate><asp:LinkButton ID="btnCancel" runat="server" CssClass="btn-table btn-secondary" CommandArgument=<%# Eval("Leave_ID") %>  OnCommand="itemcommand">Cancel</asp:LinkButton>
                                            </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
                ...
                <!-- Modal Section -->
                <!-- btnFileLeave -->
                <div class="modal modal-file-leave">
              ...
              > -->
                        ...
                        <div class="">
                            ...
                            <p class="note">Vacation has a maximum of # days leave.</p>
                            <p class="note">Sick has a maximum of # days leave.</p>
                            <p class="note">Emergency has a maximum of # days leave.</p>
                            <label class="label-6">Type</label>
                            <div class="modal-rd-container">
                                <label for="rdVacation" class="radio">
                                    <input type="radio" name="rdType" id="rdVacation" class="hidden"  runat="server"/>
                                    <span class="label"></span>Vacation
                                </label>

                                <label for="rdSick" class="radio">
                                    <input type="radio" name="rdType" id="rdSick" class="hidden" runat="server" />
                                    <span class="label"></span>Sick
                                </label>
                                <label for="rdEmergency" class="radio">
                                    <input type="radio" name="rdType" id="rdEmergency" class="hidden" runat="server" />
                                    <span class="label"></span>Emergency
                                </label>
                            </div>
                            ...
                            <label for="txtAreaReason" class="label-6">Reason</label>
                            <textarea name="txtAreaReason" id="txtAreaReason" runat="server"></textarea>
                        </div>
                        <div class="modal-btn-container">
                            <a class="btn-sm btn-primary mx-3" runat="server" id="btnRequest" onserverclick="btnRequest_Click">Request Leave</a>
                            <a class="btn-sm btn-secondary mx-3" onclick="closeModal(`#btnCloseFileLeave`);">Cancel</a
                >
              </div>
            </div>
          </div>
