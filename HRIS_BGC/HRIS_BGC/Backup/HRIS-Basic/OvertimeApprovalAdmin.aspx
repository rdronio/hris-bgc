<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OvertimeApprovalAdmin.aspx.cs" Inherits="HRIS_Basic.OvertimeApprovalAdmin" %>
  ...
  <body>
    <form action="#" autocomplete="off" runat="server">
      ...
      <div class="main">
          ...
          <ul class="nav-list">
            ...
            <li>
              ...
              <ul class="nav child_menu hidden">
                ...
                <li class="current-page"><a href="OvertimeApprovalAdmin.aspx">Overtime Approval</a></li>
                <li>
        ...
        <!-- Overtime Approval -->
        <section id="overtime-approval" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
            ...
            <div class="card card-1">
              ...
              <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                 <table class="tableLayout">
                                    <asp:DataGrid ID="dgOvertimeAdmin" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnCancel" runat="server" CssClass="fas fa-check btn-circle btn-green" CommandArgument=<%# Eval( "Overtime_ID") %> CommandName="Approve" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="fas fa-times btn-circle btn-red" CommandArgument=<%# Eval( "Overtime_ID") %> CommandName="Reject" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
