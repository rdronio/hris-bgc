            ...
            <li>
              ...
              ></a>
                            <ul class="nav child_menu hidden">
                                ...
                                <li>
                                    <a href="overtimerecords.html">Overtime Records</a>
                                </li>
                                <li>
                                    <a href="expense.html">Expense Records</a>
                                </li>
                                <li>
                                    <a href="undertime.html">Undertime Records</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <a href="underconstruction.html"><i class="fas fa-users"></i>Team</a
              >
            </li>
            <li>
              <a href="projecttask.html"
                ><i class="fas fa-tasks"></i>Project/Task</a
              >
            </li>
            <li>
              <a href="#"
                ><i class="fas fa-chart-area"></i>Report<span
                  class="fa fa-chevron-down"
                ></span
              ></a>
                            <ul class="nav child_menu hidden">
              ...
              <a href="#" onclick="toggleMenu()">
                       ...
                       <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Pending Records Available" Visible="false"></asp:Label>
                             <table class="tableLayout">
                                    <asp:DataGrid ID="dgHoliday" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DATE" DataField="holiday_date"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DESCRIPTION" DataField="holiday_desc" HeaderStyle-HorizontalAlign="Center"
                                           ...
                                           <ItemTemplate>
                                        <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn-table btn-secondary" Text="Edit" CommandArgument=<%# Eval( "holiday_id") %> CommandName="Edit" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn-table btn-secondary" Text="Delete" CommandArgument=<%# Eval( "holiday_id") %> CommandName="Delete" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
                ...
                >&times;</span> -->
                            ...
                            <div class="">
                                ...
                                <input name="txtDate" type="text" id="txtDate" runat="server" class="datePicker" />
            ...
            <div class="modal-content">
              ...
              <div class="">
                ...
                <input
                    name="txtDescription"
                    type="text"
                    id="txtEditDescription" runat="server"
                />
              </div>
              <div class="modal-btn-container">
