<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerateDtrReport.aspx.cs"
    Inherits="HRIS_Basic.GenerateDtrReport" %>
...
<body>
    ...
    <div class="main ">
        ...
        <nav id="nav">
          ...
          <ul class="nav-list">
            <li>
              <a href="payrolldashboard.html"
                ><i class="fas fa-tachometer-alt"></i>Payroll Dashboard</a
              >
            </li>
            <li>
              <a href="payroll.html"
            ...
            <li>
              ...
              <ul class="nav child_menu">
                <li class="current-page">
                  <a href="generatedtrreport.html">Generate DTR Report</a>
                </li>
                <li>
                  <a href="payrollreport.html">Payroll Report</a>
                </li>
                <li>
                  <a href="payrollpayslip.html">Payslips</a>
                </li>
              </ul>
            </li>
            <li>
        ...
        <!-- Generate DTR Report -->
        <section id="dtr-report" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
          ...
          <div class="container">
            ...
            <div class="card card-1">
              <div class="btn-tools-container">
                <div>
                  <a
                    class="btn-table btn-tools"
                    id="btnExportModal"
                    onclick="toggleDropDown();"
                    ><i class="fas fa-file-download"></i> Export
                  </a>
                  <div class="btn-dropdown hidden">
                    <button class="" id="btnExportToExcelModal" runat="server" onserverclick="btnExportToExcelModal_Click">Export to excel </button>
                    <button class="" id="btnExportToLogModal">Export to log </button>
                    <button class="" id="btnExportToTextModal">Export to text </button>
                  </div>
                </div>
                <a class="btn-table btn-tools" id="btnPrint"
                  ><i class="fas fa-print"></i>
                  Print
                </a>
              </div>
              <div>
                <label class="label-6">DTR Period</label>
                <div class="datePeriod">
                  <label for="txtDateFrom" class="label-6 item-1">From: </label>
                  <input
                    name="txtDateFrom"
                    type="text"
                    id="txtDateFrom" runat="server"
                    class="datePicker  item-2"
                  />
                  <!-- <a class="icon"><i class="far fa-calendar-alt"></i></a> -->
                  <label for="txtDateTo" class="label-6  item-3">To: </label>
                  <input
                    name="txtDateTo"
                    type="text"
                    id="txtDateTo" runat="server"
                    class="datePicker  item-4"
                  />
                  <!-- <a class="icon"><i class="far fa-calendar-alt"></i></a> -->
                </div>
              </div>
              ...
              <div>
                <label class="label-6 block">Employee Selection</label>
                <div class="modal-rd-container">
                  ...
                  >
                    <input
                      type="radio"
                      name="employeeSelection"
                      id="optCustom" runat="server"
                      class="hidden"
                      value="Custom"
                    />
                    <span class="label"></span>Custom
                  </label>
                </div>
              </div>
              ...
              <div class="div1 hidden">
                ...
                >
                <asp:DropDownList ID="drpDepartment" CssClass="select" runat="server" required >
                 </asp:DropDownList>
              </div>

              <div class="div2 hidden">
                <label for="showEmployeeBy" class="label-6 block"
                  >Show Employee by</label
                >
                 ...
                 <asp:DropDownList ID="drpEmployeeByDepartment" CssClass="select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpEmployeeByDepartment_SelectedIndexChanged" Visible="false" required>
                 </asp:DropDownList>
                 <asp:DropDownList ID="drpEmployeeByPosition" CssClass="select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpEmployeeByPosition_SelectedIndexChanged" Visible="false" required>
                 </asp:DropDownList>
              </div>

              <div class="div3 hidden">
                <label for="drpDownEmployee" class="label-6 block"
                  >Select Employee</label>
                <input
                  type="text"
                  list="drpDownEmployee"
                  class="select block"
                ...
                />
                 ...
                 <datalist id="drpDownEmployee" runat="server">
                 <asp:Repeater ID="Repeater1" runat="server">  
                 <ItemTemplate>
                 <option id="<%#Eval("Emp_ID")%>"><%#Eval("Emp_fname")%>&nbsp;<%#Eval("Emp_lname")%></option>
                  </ItemTemplate>
                 </asp:Repeater> 
                </datalist>
              ...
              <div class="btn-container">
                <a class="btn-sm btn-primary mx-3" id="btnGenerateDTR" runat="server" onserverclick="btnGenerateDTR_Click">
                  Generate DTR
                </a>

                <a class="btn-sm btn-secondary mx-3" id="btnClearDTR">
                  Clear
                </a>
              </div>

              <!-- DTR -->
              <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
               <table class="tableLayout">
                                    <asp:DataGrid ID="dgGenerateDTR" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE ID" DataField="Emp_ID"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE NAME" DataField="Emp_fname" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DEPARTMENT" DataField="Department_ID"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="POSITION" DataField="Position_ID"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            ...
                                            <ItemTemplate><asp:LinkButton ID="btnView" runat="server" CssClass="btn-table btn-secondary" CommandArgument=<%# Eval("Emp_ID") %>  OnCommand="itemcommand">View</asp:LinkButton>
                                            </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
          ...
          <!-- Modal View Employee: btnViewEmployee -->
          <div class="modal modal-view-dtr">
            <div class="modal-content">
              <h4>Daily Time Records</h4>
              <hr />

              <div class="summary-employee-info-container ">
                <div>
                  ...
                  <div class="summary-employee-info-content">
                    <div>
                      <label for="txtEmpName" class="label-6"
                        >Employee ID
                      </label>
                      <p name="txtEmpName" id="txtEmpIDView" runat="server">00001</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p name="txtEmpName" id="txtEmpNameView" runat="server">John Doe</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p name="txtEmpName" id="txtDepartment" runat="server">IT Department</p>
                    </div>

                    <div>
                      <label for="txtEmpName" class="label-6">Position </label>
                      <p name="txtEmpName" id="txtPosition" runat="server">Programmer</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p name="txtEmpName" id="txtEmpStatus" runat="server">Regular</p>
                    </div>
                  </div>
                </div>
                <div>
              ...
              <div id="time-records">
                <!-- Time Records -->
                 ...
                 <asp:Label ID="lblNoTimeRecord" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                            <table class="tableLayout">
                                <asp:DataGrid ID="dgTimeRecordTable" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
              ...
              <table class="tableLayout">
                                <asp:DataGrid ID="dgDownload" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE NAME" DataField="Emp_ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DATE" DataField="DATE" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TIME IN" DataField="TIMEIN" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TIME OUT" DataField="TIMEOUT" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        </Columns>
