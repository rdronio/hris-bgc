<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UndertimeRecordsApproval.aspx.cs" Inherits="HRIS_Basic.UndertimeRecordsApproval" %>
  ...
  <body>
    <form action="#" autocomplete="off" runat="server">
      ...
      <div class="main">
        ...
        <!-- Undertime Approval -->
        <section id="undertime-approval" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
          ...
          <div class="container">
            ...
            <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                 <table class="tableLayout">
                                    <asp:DataGrid ID="dgUndertimeAdmin" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnCancel" runat="server" CssClass="fas fa-check btn-circle btn-green" CommandArgument=<%# Eval( "undertime_id") %> CommandName="Approve" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="fas fa-times btn-circle btn-red" CommandArgument=<%# Eval( "undertime_id") %> CommandName="Reject" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
          ...
          <!-- Remarks -->
          <div class="modal modal-undertime-remarks">
            <div class="modal-content-sm">
              ...
              <div class="modal-btn-container">
                <a class="btn-sm btn-primary mx-3" runat="server" id="btnOkay" onserverclick="btnRemarks_Click">Okay</a>
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModalUndertimeRemarks();"
                  >Cancel</a
                >
              </div>
            </div>
