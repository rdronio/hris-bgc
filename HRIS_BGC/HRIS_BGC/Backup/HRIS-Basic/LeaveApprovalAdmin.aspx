<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveApprovalAdmin.aspx.cs" Inherits="HRIS_Basic.LeaveApprovalAdmin" %>
    ...
    <body>
        ...
        <!-- Leave Approval -->
        <section id="leave-approval" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
            ...
            <div class="container">
                ...
                <div class="card card-1">
                    <div class="">
                        <label class="label-6 block">Filter Date</label>
                    ...
                    <div>
                        <a class="btn-sm btn-secondary">Clear</a>
                    </div>

                    <!-- Leave Approval --> 
                    <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                    <table class="tableLayout">
                        <asp:DataGrid ID="dgLeaveApproval" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                            <Columns>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DATE" DataField="file_date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE" DataField="FullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TYPE" DataField="leave_type" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="FROM" DataField="leave_from" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TO" DataField="leave_to" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="NO. OF DAYS" DataField="numberOfDays" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="REASON" DataField="reason" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="ACTION" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="btn-circle-container" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnCancel" runat="server" CssClass="fas fa-check btn-circle btn-green" CommandArgument=<%# Eval( "Leave_ID") %> CommandName="Approve" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="fas fa-times btn-circle btn-red" CommandArgument=<%# Eval( "Leave_ID") %> CommandName="Reject" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
            ...
            <!-- Modal Section -->
            <!-- WithPay -->
            <div class="modal modal-with-pay">
                <div class="modal-content">
                <h4>Approval Confirmation</h4>
                 <hr />
                    <label class="label-6">With Pay</label>
                    <div class="modal-rd-container">
                    
                        <label for="rdYesPay" class="radio">
                            <input runat="server" type="radio" name="rdType" id="rdYesPay" class="hidden" />
                            <span class="label"></span>Yes
                        </label>

                        <label for="rdNoPay" class="radio">
                            <input runat="server" type="radio" name="rdType" id="rdNoPay" class="hidden" />
                            <span class="label"></span>No
                        </label>
                    </div>

                    <div class="modal-btn-container">
                        <a class="btn-sm btn-primary mx-3" id="btnApproveLeave" runat="server" onserverclick="btnApproveLeave_Click">Approve</a>
                        <a class="btn-sm btn-secondary mx-3" onclick="closeModalWithPay();">Cancel</a
                >
              </div>
            </div>
          </div>
          ...
          <!-- leave Remarks -->
          <div class="modal modal-leave-remarks">
            <div class="modal-content">
              <p class="notif notif-red" id="lblNotEnoughLeave" runat="server">Not Enough Available Leave Credit</p>
              <label class="label-6" for="modalRemarksTA">Remarks</label>
              <textarea name="modalRemarksTA" id="modalRemarksTA" runat="server"></textarea>

              <div class="modal-btn-container">
                <a class="btn-sm btn-primary mx-3" id="btnReject" runat="server" onserverclick="btnReject_Click">Okay</a>
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModalLeaveRemarks();"
                  >Cancel</a
                >
              </div>
            </div>
