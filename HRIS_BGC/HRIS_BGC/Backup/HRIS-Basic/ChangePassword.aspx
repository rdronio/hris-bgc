<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="HRIS_Basic.ChangePassword" %>
  ...
  <body>
    ...
    <section id="login">
      ...
      <div class="left-container">
        ...
        <label id="lblInvalid" class="warning hidden"
          >Invalid Username or Password.</label
        >
        <label id="lblChangePassword" class="warning hidden"
          >Please change your password.</label
        >
        <label for="txtPass">New Password</label>
        <input type="password" id="txtPass" runat="server" autofocus required />
        ...
        <input type="password" id="txtPass2"  runat="server" required />
        <div class="showPass-container">
          <input
            type="checkbox"
            name="showPass2"
          ...
          />
          <label for="showPass2" class="showPass">Show Password</label>
        </div>

        <button id="btnchangepass" runat="server" onserverclick="btnchangepass_Click" class="btn btn-primary">
          Change Password
        </button>
