<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeMasterlist.aspx.cs" Inherits="HRIS_Basic.EmployeeMasterlist" %>
                ...
                <div class="container">
                    ...
                    <div class="card card-1">
                        ...
                        <asp:Label ID="Label1" runat="server"></asp:Label>
                            <asp:Button ID="UploadButton" CssClass="btn-sm btn-primary" runat="server" Text="Upload" OnClick="UploadButton_Click" />

                        <!-- masterlist -->

                        <asp:DataGrid ID="dgPayroll" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                            <Columns>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee ID" DataField="EmployeeID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee Name" DataField="EmployeeName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Timekeeping" DataField="Timekeeping" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            </Columns>
                        </asp:DataGrid>

                        
                        <div class="success" id="lblSuccess" runat="server">
                            <i class="far fa-check-circle" id="lblCircle"></i>
                            <h3 runat="server">Successfully saved!</h3>
                        </div>

                        <div class="btn-container">

                     <asp:Button ID="btnSave" CssClass="btn-sm btn-primary mx-3" runat="server" Text="Save" OnClick="btnSave_Click" />
                <a class="btn-sm btn-secondary mx-3" id="btnClearMasterlist" runat="server"
                  >Clear</a
                >
              </div>
            </div>
