<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeAlterationApproval.aspx.cs" Inherits="HRIS_Basic.TimeAlterationApproval" %>
    ...
    <body>
        ...
        <!-- Leave Approval -->
        <section id="time-alteration-approval" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
            ...
            <div class="container">
                <h2>Time Alteration Approval</h2>
                <div class="card card-1">
                    ...
                    <!-- Time Alteration Approval -->
                    <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                     <table class="tableLayout">
                        <asp:DataGrid ID="dgTimeAlterationApproval" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="ACTION" HeaderStyle-HorizontalAlign="Center" ItemStyle-CssClass="btn-circle-container" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnCancel" runat="server" CssClass="fas fa-check btn-circle btn-green" CommandArgument=<%# Eval( "timealteration_id") %> CommandName="Approve" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="fas fa-times btn-circle btn-red" CommandArgument=<%# Eval( "timealteration_id") %> CommandName="Reject" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
