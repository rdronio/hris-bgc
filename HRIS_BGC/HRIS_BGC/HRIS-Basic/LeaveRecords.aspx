...
<%--                    <div id="tab">
                    ...
                    File a leave
                        ...
                        <label class="label-6 block hidden">Show record status</label>
                        <select name="showEmployeeBy" id="showEmployeeBy" class="select hidden" onchange="">
                       ...
                       <table class="tableLayout">
                                    <asp:DataGrid ID="dgLeave" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee Name" DataField="FullName"
              ...
              > -->
                        ...
                        <div class="">
                            ...
                            <label for="txtDepartment" class="label-6">Department </label>
                             <asp:DropDownList ID="drpDepartment" CssClass="select" runat="server" OnSelectedIndexChanged="drpDepartment_SelectedIndexChanged" AutoPostBack="true" required >
                             </asp:DropDownList>

                            <label for="txtEmployee" class="label-6">Employee </label>
                        ...
                        <div class="modal-btn-container">
                            <a class="btn-sm btn-primary mx-3" runat="server" id="btnRequest" onserverclick="btnRequest_Click">File Leave</a>
