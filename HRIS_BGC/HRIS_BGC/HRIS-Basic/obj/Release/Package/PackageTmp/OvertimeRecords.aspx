g
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OvertimeRecords.aspx.cs" Inherits="HRIS_Basic.OvertimeRecords" %>
    ...
    <body>
        ...
        <!-- Time Records -->
        <section id="overtime-records" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
            ...
            <div id="tab">
              <ul class="tab-list" onclick="selectTab();">
                <li class="current-tab"> 
                  <a onclick="showOR()">Overtime Records</a>
                </li>
                <li>
                  <a onclick="showPOA()">Pending Overtime Alteration</a>
                </li>
              </ul>
            </div>
                <div class="card card-1">
                    <div>
                        ...
                        <a class="btn-sm btn-primary" id="btnTimeAlteration" onclick="openModal(`#btnOvertimeApplication`);">
                  File an Overtime
                </a>
                    </div>
                    <div>
                ...
                <div class="card card-2">
                    <h3>Pending Overtime Alteration</h3>
                    <hr />
                    <div class="container-sm">
                        ...
                        <table class="tableLayout">
                                    <asp:DataGrid ID="dgPendingOvertime" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout"
                                        CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center"
                                        AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <ItemTemplate><asp:LinkButton ID="btnCancel" runat="server" CssClass="btn-table btn-secondary" CommandArgument=<%# Eval("Overtime_ID") %>  OnCommand="itemcommand">Cancel</asp:LinkButton>
                                            </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
            ...
            <!-- Modal Section -->
            <!-- btnOvertimeApplication -->
            <div class="modal modal-overtime-application">
                <div class="modal-content">
                    <h5>Overtime Application Form</h5>
                    <hr />
                    <div class="">
                        <label for="txtDateOT" class="label-6">Date: </label>
                        <input name="txtDateOT" type="text" id="txtDateOT" class="otPicker" runat="server" />
<%--                        <label for="txtOvertime" class="label-6">Overtime</label>
                        <p class="text" id="txtOvertime">0.00</p>--%>
                        <label for="txtAreaReasonOT" class="label-6">Reason</label>
                        <textarea name="txtAreaReasonOT" id="txtAreaReasonOT" runat="server"></textarea>
                    </div>
                    <div class="modal-btn-container">
                        <a class="btn-sm btn-primary mx-3" id="btnRequestOvertime" runat="server" onserverclick="btnRequestOvertime_Click">Request Overtime</a
                >
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModal(`#btnCloseOvertimeApplication`);"
                  >Cancel</a
                >
              </div>
            </div>
