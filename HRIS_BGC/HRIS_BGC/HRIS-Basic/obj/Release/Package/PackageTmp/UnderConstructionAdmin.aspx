<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnderConstructionAdmin.aspx.cs" Inherits="HRIS_Basic.UnderConstructionAdmin" %>
      ...
      <nav id="nav">
        ...
        <!-- / menu -->
          <ul class="nav-list">
            ...
            <li>
              <a href="#"
                ><i class="fas fa-bullhorn"></i>Memo & Annountments<span
                  class="fa fa-chevron-down"
                ></span
              ></a>
              <ul class="nav child_menu hidden">
