<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UndertimeRecords.aspx.cs" Inherits="HRIS_Basic.UndertimeRecords" %>
              ...
              <a href="#" onclick="toggleMenu()">
                ...
                <div class="modal modal-undertime-application">
                    <div class="modal-content">
                        <h5>Undertime Application Form</h5>
                        <hr />
                        <div class="">
                            <label for="txtDateUT" class="label-6">Date: </label>
                            <input name="txtDateUT" type="text" id="txtDateUT" class="utPicker" runat="server" />
                            <label for="txtHours" class="label-6">Hours</label>
                            <p class="text" id="txtHours">0.00</p>
                            <label for="txtUndertime" class="label-6">Undertime</label>
                        ...
                        <div class="modal-btn-container">
                            <a class="btn-sm btn-primary mx-3" id="btnRequestUndertime" runat="server" onserverclick="btnRequestUndertime_Click">Request Undertime</a
                >
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModal(`#btnCloseUndertimeApplication`);"
                  >Cancel</a
                >
              </div>
            </div>
