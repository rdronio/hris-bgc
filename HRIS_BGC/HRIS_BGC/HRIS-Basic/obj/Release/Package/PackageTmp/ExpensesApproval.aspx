<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpensesApproval.aspx.cs" Inherits="HRIS_Basic.ExpensesApproval" %>
    ...
    <body>
        <form action="#" autocomplete="off" runat="server">
          ...
          <div class="close-menu">
            ...
            <!-- Expense Approval -->
            <section id="expense-approval" class="content">
                <!-- TOP NAV  -->
                <div class="top-nav">
                    <span class="menu-btn">
              <a href="#" onclick="toggleMenu()">
                    ...
                    <div class="card card-1">
                        ...
                        <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                         <table class="tableLayout">
                                    <asp:DataGrid ID="dgExpenseAdmin" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnApprove" runat="server" CssClass="fas fa-check btn-circle btn-green" CommandArgument=<%# Eval( "expense_id") %> CommandName="Approve" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="btnCancel" runat="server" CssClass="fas fa-times btn-circle btn-red" CommandArgument=<%# Eval( "expense_id") %> CommandName="Reject" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
                ...
                <!-- Remarks -->
                <div class="modal modal-expense-remarks">
                    <div class="modal-content-sm">
                        <label class="label-6" for="modalRemarksTA">Remarks</label>
                        <textarea name="modalRemarksTA" id="txtRemarks" runat="server"></textarea>

                        <div class="modal-btn-container">
                            <a class="btn-sm btn-primary mx-3" id="btnRemarks" runat="server" onserverclick="btnRemarks_Click">Okay</a>
                            <a class="btn-sm btn-secondary mx-3" onclick="closeModalExpenseRemarks();">Cancel</a
                >
              </div>
            </div>
          </div>
