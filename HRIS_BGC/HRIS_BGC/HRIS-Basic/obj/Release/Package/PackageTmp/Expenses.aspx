<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="HRIS_Basic.Expenses" %>
  ...
  <body>
    <form action="#" autocomplete="off" runat="server">
      ...
      <div class="main">
          ...
          <ul class="nav-list">
            ...
            <li>
              ...
              <ul class="nav child_menu hidden">
                <li>
                  <a href="UnderConstructionPage.aspx">Payslip</a>
                </li>
              </ul>
            </li>
            <li>
        ...
        <!-- Expense Records -->
        <section id="expense-records" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
            ...
            <div id="tab">
              <ul class="tab-list" onclick="selectTab();">
                <li class="current-tab">
                  <a onclick="showER()">Expense Records</a>
                </li>
                <li>
                  <a onclick="showPE()">Pending Expense</a>
                </li>
              </ul>
            </div>
            <div class="card card-1">
              <div>
                <a
                  ...
                  id="btnExpense"
                  onclick="openModal(`#btnAddExpense`);"
                >
                  Add Expense
                </a>
              </div>
              ...
              <asp:Label ID="lblNoRecords" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                     <table class="tableLayout">
                                    <asp:DataGrid ID="dgExpenses" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DESCRIPTION" DataField="expense_description" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="REASON" DataField="expense_reason"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="RATE" DataField="expense_rate"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
            ...
            <div class="card card-2 hidden">
              <div class="container-sm">
                <!-- Pending Time Alteration -->
                 <!-- Expenses Records -->
                    <asp:Label ID="lblNoPendingRecords" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                     <table class="tableLayout">
                                    <asp:DataGrid ID="dgPendingExpenses" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout"
                                        CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center"
                                        AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <ItemTemplate><asp:LinkButton ID="btnCancel" runat="server" CssClass="btn-table btn-secondary" CommandArgument=<%# Eval("expense_id") %>  OnCommand="itemcommand">Cancel</asp:LinkButton>
                                            </ItemTemplate>
                                            </asp:TemplateColumn>
                ...
                <div class="pagination-container">
                  <div class="showmore-container">
                    <a class="btn-showmore" href="#"
                      ><i class="fas fa-chevron-down"></i>Show More</a
                    >
                  </div>
                  <div class="pagination" onclick="selectPage()">
                    <a href="#">«</a>
          ...
          <!-- Modal Section -->
          <!-- btnExpenseApplication -->
          <div class="modal modal-expense-application">
            <div class="modal-content">
              <h5>Expense Application Form</h5>
              <hr />
              <div class="">
                <label for="txtDateExpense" class="label-6">Date: </label>
                <input
                  name="txtDateExpense"
                  type="text"
                  id="txtDateExpense"
                  class="otPicker" runat="server"
                />
                <label for="txtDescExpense" class="label-6"
                  >Description:
                </label>
                <input name="txtDescExpense" type="text" id="txtDescExpense" runat="server"/>

                <label for="txtRateExpense" class="label-6">Rate: </label>
                <input name="txtRateExpense" type="text" id="txtRateExpense" runat="server"/>

                <label for="txtAreaReasonOT" class="label-6">Reason</label>
                <textarea
                  name="txtAreaReasonOT"
                  id="txtAreaReason" runat="server"
                ></textarea>
              </div>
              <div class="modal-btn-container">
                <a class="btn-sm btn-primary mx-3" id="btnSubmitExpense" runat="server" onserverclick="btnSubmitExpense_Click"
                  >Submit Form</a
                >
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModal(`#btnCloseAddExpense`);"
                  >Cancel</a
                >
              </div>
            </div>
