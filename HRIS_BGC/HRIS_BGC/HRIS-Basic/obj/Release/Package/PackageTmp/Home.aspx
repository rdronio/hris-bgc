<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="HRIS_Basic.Home" %>
       ...
       <div class="main">
            ...
            <a href="#" onclick="toggleMenu()">
              <svg>
                ...
                <div class="container">
                    <h2>Home</h2>
                    <div class="card card-1 py-1">
                        <label id="lblTime" class="label-0" runat="server"></label>
                        <label id="lblDate" class="label-3" runat="server"></label>
                        <div class="">
                            <button id="btnIn" class="btn btn-green" runat="server" onserverclick="btnTimeIn_Click">In</button>
                            <button id="btnOut" class="btn btn-red" runat="server" onserverclick="btnTimeOut_Click">Out</button>
                        </div>
                    </div>
                        ...
                        <div class="container-lg">
                            <div class="container-md">
                                <div class="container-sm">
                                    <label class="label-5">Date</label>
                                    <label id="lblDate2" class="label-3">Month Day, Year</label>
                                </div>
                                <div class="container-sm">
                                    <label class="label-5">Time In</label>
                                    <label id="lblTimeIn2" class="label-3" runat="server">--:-- --</label>
                                </div>
                                <div class="container-sm">
                                    <label class="label-5">Time Out</label>
                                    <label id="lblTimeOut2" class="label-3" runat="server">--:-- --</label>
                                </div>
                            </div>
                            <div class="container-md">
                                <div class="container-sm">
                                    <label class="label-5">Total</label>
                                    <label id="lblTotal2" class="label-3" runat="server">0.00</label>
                                </div>
                                <div class="container-sm">
                                    <label class="label-5">Overtime</label>
                                    <label id="lblOvertime2" class="label-3" runat="server">0.00</label>
                                </div>
                                <div class="container-sm">
                                    <label class="label-5">Tardiness</label>
                                    <label id="lblTardiness" class="label-3" runat="server">0.00</label>
                                </div>
                            </div>
                        </div>
                    </div>
