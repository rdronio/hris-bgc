            ...
            <div>
              <div class="card-db card-1 card-md">
                ...
                <hr />
                                ...
                                <asp:DataGrid ID="dgHoliday" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayoutDB" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
              ...
              <div class="card-db card-1 card-md">
                ...
                <hr />
                <div>
                  <label class="label-6">Payroll Approvals: </label>
                  <p id="lblPPA" runat="server" class="bg-circle">0</p>
                  <label class="label-6">Leaves Approvals: </label>
                  <p id="lblPLA" runat="server" class="bg-circle">0</p>
                  <label class="label-6">Overtime Approvals: </label>
                  <p id="lblPOA" runat="server" class="bg-circle">0</p>
                  <label class="label-6">Time Alterations Approvals: </label>
                  <p id="lblPTAA" runat="server" class="bg-circle">0</p>
                  <label class="label-6">Expense Approvals: </label>
                   <p id="lblEA" runat="server" class="bg-circle">0</p>
                   <label class="label-6">Undertime Approvals: </label>
                   <p id="lblUA" runat="server" class="bg-circle">0</p>
                </div>
              </div>
              <div class="card-db card-1 card-md">
                  ...
                  <hr />
                    <asp:Label ID="lblLeaveToday" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgLeaveToday" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayoutDB" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
              ...
              <div class="card-db card-1 card-md">
                  ...
                  <asp:Label ID="lblEvaluation" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgEvaluation" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayoutDB" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="NAME" DataField="FullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="POSITION" DataField="position_title" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    </Columns>
                  ...
                  <div>
                    ...
                    <div>
                      <label for="searchEmployee" class="label-6 block"
                        >Search Employee ID/Name</label
                      >
                      <input type="" value="" id="searchRegularEmployee" />
                    </div>
                  </div>
                  <!-- Daily Time Record -->
                   <asp:Label ID="NoList" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgRegular" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayoutDB" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                     <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE ID" DataField="Emp_ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE NAME" DataField="FullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
