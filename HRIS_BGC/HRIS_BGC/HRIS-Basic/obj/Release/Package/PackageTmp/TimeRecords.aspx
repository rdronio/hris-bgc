        ...
        <form id="Form1" action="#" autocomplete="off" runat="server">
            ...
            <div class="main">
                ...
                <nav id="nav">
                    ...
                    <ul class="nav-list">
                        <li>
                            <a href="Home.aspx"><i class="fas fa-tachometer-alt"></i>Dashboard</a
              >
            </li>
            <li  class="current-page">
              <a href="TimeRecords.aspx"
                ><i class="fas fa-user-clock"></i>Time Records</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="#"
                ><i class="fas fa-history"></i>Application<span
              ...
              ></a>
                            <ul class="nav child_menu hidden">
                                ...
                                <li>
                                    <a href="OvertimeRecords.aspx">Overtime Records</a>
                                </li>
                                  <li>
                                     <a href="Expenses.aspx">Expense Records</a>
                                </li>
                                <li>
                        ...
                        <li class="hidden">
                            <a href="#"><i class="fas fa-tasks"></i>Approvals<span
                  class="fa fa-chevron-down"
                ></span
              ></a>
                            <ul class="nav child_menu hidden">
                        ...
                        <li>
                            <a href="UnderConstructionPage.aspx"><i class="fas fa-users"></i>Team</a>
                        </li>
                        <li>
                            <a href="UnderConstructionPage.aspx"><i class="fas fa-tasks"></i>Project/Task</a>
                        </li>
                        <li>
                            <a href="#"><i class="far fa-file-alt"></i>Report<span
                  class="fa fa-chevron-down"
                ></span
              ></a>
                            <ul class="nav child_menu hidden">
                                <li>
                                    <a href="UnderConstructionPage.aspx">DTR</a>
                                </li>
                                <li>
                                    <a href="UnderConstructionPage.aspx">BIR</a>
                                </li>
                            </ul>
                        </li>
                        <li>
