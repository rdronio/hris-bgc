<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageEmployees.aspx.cs"
    MaintainScrollPositionOnPostback="true" Inherits="HRIS_Basic.ManageEmployees" %>
...
<head runat="server">
    ...
    <%--<link rel="stylesheet" href="https://systemohr-bgc.netlify.com/Styles/style.css"/>--%>
                                    ...
                                    <asp:DataGrid ID="dgManageEmployee" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                         <asp:TemplateColumn HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <asp:LinkButton id="LinkButton1" runat="server" CssClass="btn-table btn-secondary" CommandArgument=<%# Eval("Emp_ID") %> CommandName=<%# Eval("bio_number") %>  OnCommand="itemcommandview">View</asp:LinkButton>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Bio Number" DataField="bio_number"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee Number" DataField="emp_number"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
              ...
              <div id="tabIE">
               ...
               <!-- Primary Info Tab -->
                <div id="primary-info" class="tabNameHrModal">
                    <div>
                        <div>
                            <label for="photo" class="label-6 hidden">Photo</label>
                            <div class="profile_pic hidden">
                                <input type="file" name="photo" id="photo" accept="image/*">

                                <img src="/Images/user.png" alt="Employee Picture" class="img-circle profile_img">
                            </div>

                            <label for="txtLastName" class="label-6">Last Name <span class="note-red">*</span></label>
                            <input name="txtLastName" type="text" id="txtLastName" runat="server" />

                            <label for="txtFirstName" class="label-6">Given Name <span class="note-red">*</span></label>
                            <input name="txtFirstName" type="text" id="txtFirstName" runat="server"/>

                            <label for="txtMiddleName" class="label-6">Middle Name <span class="note">(Optional)</span></label>
                            <input name="txtMiddleName" type="text" id="txtMiddleName" runat="server"/>

                            <label for="dtPickerBirthday" class="label-6">Birthday <span class="note-red">*</span></label>
                            <input name="dtPickerBirthday" type="text" id="dtPickerBirthday" class="bdayPicker" runat="server"/>

                                                        <label class="label-6">Gender <span class="note-red">*</span></label>
                            ...
                            <label class="label-6">Civil Status <span class="note-red">*</span></label>
                            <div class="modal-rd-container">
                        ...
                        <div>
                            ...
                            <label class="label-6">Address <span class="note">(Optional)</span></label>
                            ...
                            <label for="selectBrgy" class="note">Barangay</label>
                            <input name="selectBrgy" type="text" id="txtBarangay" runat="server"/>
                            <!-- <select name="selectCity" id="selectCity" class="select" onchange="getCity()"> -->
                            <%--</select>--%>
                         ...
                         <%--   <label for="txtState" class="note">State</label>
                            ...
                            <label for="txtDriversLicenseNo" class="label-6"
                              >Drivers Licence <span class="note">(Optional)</span>
                            </label>
                            <input
                              name="txtDriversLicenseNo"
                              type="text"
                              id="txtDriversLicenseNo"
                              runat="server"
                            />

                            <label for="dtExpirationDate" class="label-6"
                              >Expiration Date <span class="note">(Optional)</span>
                            </label>
                            <input
                              name="dtExpirationDate"
                              type="text"
                            ...
                            <label for="txtRestrictionCode" class="label-6"
                              >Restriction Code <span class="note">(Optional)</span>
                            </label>
                            <input
                              name="txtRestrictionCode"
                              type="text"
                              id="txtRestrictionCode"
                              runat="server"
                            />
                         </div>
                    </div>
                    ...
                    <div>
                        <div>
                            <label for="txtEmail" class="label-6">Email <span class="note">(Optional)</span></label>
                            <input name="txtEmail" type="text" id="txtEmail" runat="server" />

                            <label for="txtPhone" class="label-6">Personal Contact No. <span class="note">(Optional)</span></label>
                            <input name="txtPhone" type="text" id="txtPhone" runat="server"/>
                        </div>

                        <div>
                            <label for="txtEmergencyContact" class="label-6">Emergency Contact Name <span class="note">(Optional)</span></label>
                            <input name="txtEmergencyContact" type="text" id="txtEmergencyContact" runat="server"/>

                            <label for="txtEmergencyContactNo" class="label-6">Emergency Contact No. <span class="note">(Optional)</span></label>
                ...
                <div id="hr-info" class="tabNameHrModal" style="display:none">
                    ...
                    <div>
                        <label for="txtBioNumber" class="label-6">Bio Number <span class="note">(Optional)</span></label>
                        <input
                            name="txtBioNumber"
                            id="txtBioNumber"
                            min="0"
                        ...
                        />
                         ...
                         <label for="txtEmpIdNumber" class="label-6"
                            >Employee ID Number <span class="note">(Optional)</span></label
                          >
                          <input
                            name="txtEmpIdNumber"
                            id="txtEmpIdNumber"
                        ...
                        <label for="txtDateEmployed" class="label-6">Date Hired <span class="note-red">*</span></label>
                        <input name="txtDateEmployed" type="text" id="txtDateEmployed" class="datePicker" runat="server" />

                        <label for="drpDepartment" class="label-6">Department <span class="note-red">*</span></label>
                        ...
                        <asp:DropDownList ID="drpDepartmentUpdate" CssClass="select hidden" OnSelectedIndexChanged="drpDepartmentUpdate_SelectedIndexChanged" AutoPostBack="true" runat="server" required >
                        </asp:DropDownList> 

                        <label for="selectPosition" class="label-6">Position <span class="note-red">*</span></label>
                        <asp:DropDownList ID="drpPosition" CssClass="select" runat="server" required >
                        </asp:DropDownList>



                        <label for="selectManager" class="label-6 hidden">Manager <span class="note">(Approver)</span></label>
                        <select name="selectManager" id="selectManager" class="select hidden">
                        </select>

                        <label for="txtSalary" class="label-6">Basic Salary <span class="note-red">*</span></label>
                        <input name="txtSalary" min="0" id="txtSalary" runat="server"/>

                        <br> 
                        <label for="selectShift" class="label-6">Shift <span class="note">(Optional)</span></label>
                        ...
                        <label class="label-6">Schedule <span class="note">(Military Time) </span><span class="note-red">*</span></label>
                          <label for="txtScheduleFrom" class="note">From</label>
                          <input type="text" name="txtScheduleFrom" id="txtScheduleFrom"  min="07:00" max="09:00" runat="server"/>
<%--                          <inputs
                            name="txtScheduleFrom"
                            type="text"
                            min="0"
                            id="txtScheduleFrom"
                            class="timepicker"
                          />--%>
                          <label for="txtScheduleTo" class="note">To</label>
                            <input type="text" name="txtScheduleTo" id="txtScheduleTo"  min="17:00" max="19:00" runat="server"/>
<%--                          <input
                            name="txtScheduleTo"
                            type="number"
                            min="0"
                        ...
                        <label for="selectEmploymentStatus" class="label-6">Employment status <span class="note-red">*</span></label>
                        <asp:DropDownList runat="server" id="drpEmpStatus" CssClass="select" onchange="toggleEndo();">
                        <asp:ListItem Value="0" Text="Please Select"></asp:ListItem>
                        <asp:ListItem Value="probationary" Text="Probationary"></asp:ListItem>
                        <asp:ListItem Value="regular" Text="Regular"></asp:ListItem>
                        <asp:ListItem Value="end" Text="End of Contract"></asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <div>
                        <label for="txtTinNo" class="label-6">TIN Number <span class="note">(Optional)</span></label>
                        <input name="txtTinNumber" id="txtTinNumber" min="0" maxlength="17" runat="server" />

                        <label for="txtPhilHealthNo" class="label-6">Philhealth Number <span class="note">(Optional)</span></label>
                        <input name="txtPhilHealth" id="txtPhilHealth" min="0" maxlength="15" runat="server"/>

                        <label for="txtHdmfNo" class="label-6">Pag-ibig Number <span class="note">(Optional)</span></label>
                        <input name="txtHdmfNo" id="txtHdmfNo" min="0" maxlength="15" runat="server"/>

                        <label for="txtSssNo" class="label-6">SSS Number <span class="note">(Optional)</span></label>
                        <input name="txtSssNo" id="txtSssNo" min="0" maxlength="12" runat="server"/>

                        <label for="txtCardNo" class="label-6">Debit Card Number <span class="note">(Optional)</span></label>
                        <input name="txtCardNo" min="0" id="txtCardNo" runat="server"/>

                        <br>
                        <label for="txtDateEmployed" class="label-6">Attached/Uploaded Requirements <span class="note">(Optional)</span></label>
                        <div class="modal-rd-container">
          ...
          <div class="modal modal-view-employee">
            <div class="modal-content">
              ...
              <div id="view-primary-info" class="tabViewIEList">
                <div>
                  ...
                  <div>                    
                    ...
                    <p name="txtDriversLicenseNo" id="txtViewDriversLicenseNo" runat="server">
                      ---
                    </p>

                    <label for="txtExpirationDate" class="label-6"
                      >Expiration Date
                    </label>
                    <p name="txtExpirationDate" id="txtViewExpirationDate" runat="server">
                      ---
                    </p>
                    ...
                    <p name="txtRestrictionCode" id="txtViewRestrictionCode" runat="server">---</p>
                  </div>
                </div>
                <div>
                  <div>
                  ...
                  <div>
                    ...
                    <div>
                      <label for="txtEmpState" class="note">Barangay</label>
                      <p name="txtEmpState" id="txtViewBarangay" runat="server">-----</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div id="view-hr-info" class="tabViewIEList" style="display:none">
                <div>
                  ...
                  <label for="lblManager" class="label-6 hidden">Manager <span class="note">(Approver)</span></label>
                  <p class="hidden" name="lblManager" id="lblManager" runat="server">-----</p>
                  ...
                  <label class="label-6">Schedule </label>
                  <label class="note" for="appt-time">From </label>
                  <p name="appt-time" id="lblSchedFrom" runat="server">-----</p>
                  <label class="note" for="appt">To </label>
                  <p name="appt-time" id="lblSchedTo" runat="server">-----</p>
                ...
                >
                  ...
                  <p name="lblTerminationDate" id="lblVacationLeave" runat="server">-----</p>
                  <label class="label-6">Termination Date </label>
                  <p name="lblTerminationDate" id="lblTerminationDate" runat="server">-----</p>
                </div>

                <div>
                  <label for="lblTinNo" class="label-6">TIN Number </label>
                  <p name="lblTinNo" id="lblTinNo" runat="server">----</p>
                  
                  <label for="lblPhilhealthNo" class="label-6">Philhealth Number </label>
                  <p name="lblPhilhealthNo" id="lblPhilhealthNo" runat="server">----</p>

                  <label for="lblHdmfNo" class="label-6">Pag-ibig Number </label>
                  <p name="lblHdmfNo" id="lblHdmfNo" runat="server">----</p>
                  
                  <label for="lblSssNo" class="label-6">SSS Number </label>
                  <p name="lblSssNo" id="lblSssNo" runat="server">----</p>
                  
                  <label for="lblCreditCard" class="label-6">Debit Card Number </label>
                  <p name="lblCreditCard" id="lblDebitCard" runat="server">----</p>
                                    ...
                                    <asp:DataGrid ID="dgOvertimeRecord" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DATE" DataField="date"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TOTAL HOURS" DataField="total_hours" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="REASON" DataField="reason"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        </Columns>
           ...
           <div class="pagination-container">
            <div class="pagination">
            <asp:Repeater ID="rptTimeRecords" runat="server" OnItemCommand="rptTimeRecords_ItemCommand">
                <ItemTemplate>
                <asp:LinkButton ID="lnkPageNumber" CommandName="Page" CommandArgument="<%# Container.DataItem %>"
                        runat="server" ForeColor="Black" Font-Bold="True"><%# Container.DataItem %></asp:LinkButton>
                </ItemTemplate>
              ...
              <div class="modal-btn-container">
                <a
                  class="btn-sm btn-primary mx-3"
                  onserverclick="btnredirectUpdate_Click"
                  runat="server"
