<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HolidayList.aspx.cs" Inherits="HRIS_Basic.HolidayList" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="Styles/jquery/jquery.timepicker.css" />
    <!-- JavaScript -->
...
<body>
    ...
    <div class="main">
        ...
        <!-- Time Records -->
        <section id="holiday-notice" class="content">
                <!-- TOP NAV  -->
                <div class="top-nav">
                    <span class="menu-btn">
              <a href="#" onclick="toggleMenu()">
                ...
                <div class="container">
                    ...
                    <div class="card card-1">
                        <div>
                            <a class="btn-sm btn-primary" onclick="openModal(`#btnAddHoliday`);">Add Holiday
                </a>
                        </div>

                        <div>
                            <label class="label-6 block"> Select Date: </label>

                            <select name="selectHolidayDate" id="selectHolidayDate" class="select" onchange="">
                       ...
                       <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Pending Records Available" Visible="false"></asp:Label>
                             <table class="tableLayout">
                                    <asp:DataGrid ID="dgHoliday" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="START DATE" DataField="holiday_startDate"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="END DATE" DataField="holiday_endDate" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                 <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DESCRIPTION" DataField="holiday_desc"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="NO. OF DAY/S" DataField="holiday_numberOfDays" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                           ...
                                           <ItemTemplate>
                                        <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn-table btn-secondary" Text="Edit" CommandArgument=<%# Eval( "holidaynotice_id") %> CommandName="Edit" OnCommand="itemcommand">
                                        </asp:LinkButton>
                                        <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn-table btn-secondary" Text="Delete" CommandArgument=<%# Eval( "holidaynotice_id") %> CommandName="Delete" OnCommand="itemcommand"></asp:LinkButton>
                                    </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
                ...
                <div class="pagination" onclick="selectPage()">
                  <a href="#">«</a>
                    ...
                    <!-- Modal Section -->
                    <!-- btnTimeAlteration -->
                    <div class="modal modal-add-holiday">
                        <div class="modal-content">
                            <!-- <span class="modal-close-btn" onclick="closeModal();"
                >&times;</span> -->
                            <h5>Add Holiday Form</h5>
                            <hr />
                            <div class="">
                                <label for="txtDate" class="label-6">Start Date: </label>
                                <input name="txtDate" type="text" id="txtStartDate" runat="server" class="datePicker" />

                                <label for="txtDate" class="label-6">End Date: </label>
                                <input name="txtDate" type="text" id="txtEndDate" runat="server" class="datePicker" />

                                <label for="txtTime" class="label-6">Description</label>
                                <input name="txtDescription" type="text" id="txtDescription" runat="server" />
                            </div>
                            <div class="modal-btn-container">
                                <a class="btn-sm btn-primary mx-3" id="btnSubmitAddHoliday" runat="server" onserverclick="btnSubmitAddHoliday_Click">Add Holiday</a
                >
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModal(`#btnCloseAddHoliday`);"
                  >Cancel</a
                >
              </div>
            </div>
          ...
          <div class="modal modal-edit-holiday">
            <div class="modal-content">
              <!-- <span class="modal-close-btn" onclick="closeModal();"
                >&times;</span
              > -->
              <h5>Edit Holiday Form</h5>
              <hr />
              <div class="">
                                <label for="txtDate" class="label-6">Start Date: </label>
                                <input name="txtDate" type="text" id="txtEditStartDate" runat="server" class="datePicker" />

                                <label for="txtDate" class="label-6">End Date: </label>
                                <input name="txtDate" type="text" id="txtEditEndDate" runat="server" class="datePicker" />

                                <label for="txtTime" class="label-6">Description</label>
                                <input name="txtDescription" type="text" id="txtEditDesc" runat="server" />
              </div>
              <div class="modal-btn-container">
                <a class="btn-sm btn-primary mx-3" id="btnSubmitEditHoliday" runat="server" onserverclick="btnSubmitEditHoliday_Click"
                  >Update Holiday</a
                >
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModal(`#btnCloseEditHoliday`);"
                  >Cancel</a
                >
              </div>
            </div>
