<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashboardAdmin.aspx.cs"
    Inherits="HRIS_Basic.DashboardAdmin" %>
...
<body>
    <form id="manageemployee" action="#" autocomplete="off" runat="server">
    <!-- main -->
    <div class="main ">
        <!-- nav -->
        <nav id="nav">  
        <div class="logo">
          <a href="DashboardAdmin.aspx" class="logo-link">
            <h1>LOGO HERE</h1>
            <p>
              HRIS & Payroll w/ Time Keeping System
            </p>
          </a>
        </div>
        ...
        <div class="profile">
          ...
          <ul class="nav-list">
            ...
            <li>
              ...
              <ul class="nav child_menu hidden">
                <li>
                  <a href="GenerateDtrReport.aspx">Generate DTR</a>
                </li>
              </ul>
            </li>
            <li>
        ...
        <!-- Manage Employees -->
        <section id="admin-dashboard" class="content">
        <!-- TOP NAV  -->
        <div class="top-nav">
          <span class="menu-btn">
        ...
        <div class="container">
          ...
          <div>
            <div>
              <div class="card-db card-1 card-md">
                <h5 class="card-header">Holiday Notice</h5>
                <hr />
                
                                <asp:Label ID="lblNoHoliday" runat="server" CssClass="norecords" Text="No holiday for this month." Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgHoliday" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout-md" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DATE" DataField="holiday_date" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DESCRIPTION" DataField="holiday_desc" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
                 
              </div>
             <div class="card-db card-1 card-md">
                  <h5 class="card-header">Tardiness Notice</h5>
                  <hr />
                  <!-- <label class="norecords">No Records Found</label> -->
                 <asp:Label ID="lblTardiness" runat="server" CssClass="norecords" Text="No records available." Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgTardiness" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout-md" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee" DataField="bio_number" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Total Memo Point/s" DataField="SumOfPoints" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
              </div>
              <div class="card-db card-1 card-md">
                  <h5 class="card-header">Leave Today</h5>
                  <hr />
                    <asp:Label ID="lblLeaveToday" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgLeaveToday" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout-md" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="NAME" DataField="FullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="POSITION" DataField="position_title" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
                </div>
              <div class="card-db card-1 card-md">
                  <h5 class="card-header">Evaluation Notice</h5>
                  <hr />
                  <asp:Label ID="lblEvaluation" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgEvaluation" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout-md" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="NAME" DataField="FullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="POSITION" DataField="position_title" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    </Columns>
            ...
            <div>
            <%--  <div class="card-db card card-2 card-lg">
                  <h5>Today's Employee Time Record</h5>
                  <hr />
                  <div>
                    <div>
                      <label class="label-6">Date</label>
                      <h3 id="lblDate"></h3>
                    </div>
                    <div>
                ...
                <!-- Daily Time Record -->
                 ...
                 <asp:Label ID="lblNoRecords" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgDashboard" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayoutDB" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="POSITION" DataField="POSITION" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
              ...
              <div class="card-db card card-2 card-lg">
                  <h5>List of Regular Employees</h5>
                  <hr />
                  <div>
                    <div>
                      <label class="label-6">Total Employees</label>
                      <h3 runat="server" id="lblRegCount">10</h3>
                    </div>
                    <div>
                      <label for="searchEmployee" class="label-6 block"
                        >Search Employee ID/Name</label
                      >
                      <input type="text" value="" id="txtSeachRegular" runat="server"/>
                    </div>
                  </div>
                  <!-- List of Regular Employee -->
                   <asp:Label ID="NoList" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                                <asp:DataGrid ID="dgRegular" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayoutDB" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                    <Columns>
                                     <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE ID NUMBER" DataField="emp_number" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="EMPLOYEE NAME" DataField="FullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DEPARTMENT" DataField="department_name" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="POSITION" DataField="position_title" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    </Columns>
                                </asp:DataGrid>
                    <!--Pagination-->
    ...
    <footer id="footer">
          <a href="https://systemoph.com/">
            <svg class="systemologo" width="500" height="100" viewBox="0 0 260 58" fill="none"
