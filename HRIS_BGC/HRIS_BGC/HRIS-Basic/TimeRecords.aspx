<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeRecords.aspx.cs" Inherits="HRIS_Basic.TimeRecords" %>
    ...
    <body>
        <form id="Form1" action="#" autocomplete="off" runat="server">
            <!-- main -->
            <div class="main">
                <!-- nav -->
                <nav id="nav">
                    ...
                    <ul class="nav-list">
                        <li>
                            <a href="DashboardAdmin.aspx"><i class="fas fa-tachometer-alt"></i>Admin Dashboard</a
              >
            </li>
            <li>
              <a href="#"
              ...
              ></a>
                            <ul class="nav child_menu hidden">
                                ...
                                <li>
                                    <a href="UndertimeRecords.aspx">Undertime Records</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="fas fa-file-alt"></i> Employee Records<span
                class="fa fa-chevron-down"
              ></span
            ></a>
                            <ul class="nav child_menu hidden">
                                ...
                                <li class="current-page"><a href="TimeRecords.aspx">Employee Time Records</a></li>
                            </ul>
                        </li>
                        <%--<li>
              ...
              >
                            ...
                            <li>
                                <a href="#"><i class="fas fa-bullhorn"></i>Memo/Notice<span
                  class="fa fa-chevron-down"
                ></span
              ></a>
                                <ul class="nav child_menu hidden">
              ...
              ></a>
                            ...
                            <li>
                                <a href="EmployeeMasterlist.aspx"><i class="fas fa-download"></i>Import Time Records</a
              >
            </li>
            <li>
             <a href="#"
              ...
              ></a>
                            ...
                            <li>
                                <a href="LoginPage.aspx"><i class="fas fa-sign-out-alt"></i>Sign Out</a
              >
            </li>
          </ul>
            ...
            <!-- Time Records -->
            <section id="time-records" class="content">
                <!-- TOP NAV  -->
                <div class="top-nav">
                    <span class="menu-btn">
                    ...
                    <%--                  <div id="tab">
                            <ul class="tab-list" onclick="selectTab();">
                                <li class="current-tab">
                                    <a onclick="showTR()">Time Records</a>
                                </li>
                                <li>
                                    <a onclick="showPTA()">Pending Time Alteration</a>
                                </li>
                            </ul>
                        </div>--%>
                        <div class="card card-1">
                            <div>
                                <%-- <a class="btn-sm btn-primary" onclick="openModal(`#btnTimeAlteration`);">Time Alteration
                    </a>--%>
                            </div>
                            <%--                            <div> 
                                ...
                                <a class="icon"><i class="far fa-calendar-alt"></i></a>
                            ...
                            <div>
                                <label for="selectDepartment" class="label-6 block"
                                ...
                                >
                                  ...
                                  <label for="selectEmployeeName" class="label-6 block"
                                  >Employee Name</label
                                >
                                <select
                                ...
                                <div class="search-main-container">
                                    <div class="search-container">
                                        <a class="btn-search tooltip" aria-label="Search Mail">
                                        ...
                                        <div>
                                            <input id="txtSearch" type="text" runat="server" list="txtSearch" class="select block" placeholder="Search Employee" onkeypress="checkSearchInput();" onchange="checkSearchInput();" />
                                            <ul class="datalist-data hidden">
                                                <li>
                                                ...
                                                <li class="selected-datalist">
                                                    <div><i class="fas fa-search"></i></div>
                                                    <div><span>John Doe1</span></div>
                                                    <div></div>
                                                </li>
                                                <li>
                                                    <div><i class="fas fa-search"></i></div>
                                                    <div><span>John Doe2</span></div>
                                                    <div></div>
                                                </li>
                                            </ul>
                                        </div>
                                        <a aria-label="Clear search" type="button" data-tooltip="Clear search" onclick="clearSearch(`Form1`);" class="btn-clear-search tooltip hidden">
                                            <span class="tooltiptext">Clear search</span>
                                            <svg focusable="false" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>
                                                <path d="M0 0h24v24H0z" fill="none"></path>
                                            </svg>
                                        </a>
                                        <a type="button" data-tooltip="Show search options" aria-label="Advanced search options" class="showSearchOptions" onclick="toggleSearchFilter();">
                                            <svg focusable="false" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="search-filter-container hidden">
                                        <div>
                                            <label class="block">Filter Date</label>
                                            <div class="datePeriod">
                                                <label for="txtDateFrom">From: </label>
                                                <input name="txtDateFrom" type="text" id="txtDateFrom" class="startDatePicker" runat="server"/>
                                                <label for="txtDateTo">To: </label>
                                                <input name="txtDateTo" type="text" id="txtDateTo" class="endDatePicker" runat="server"/>
                                            </div>
                                        </div>

                                        <div class="showEmployeeBy">
                                        ...
                                        <div class="btn-filter-container">
                                            <a class="btn-sm btn-primary " id="btnSearchPayroll">
                                          Search
                                        </a>

                                            <a class="btn-sm btn-secondary hidden " id="btnClearMemoNotice">
                                          Clear
                                        </a>
                                        </div>
                                    </div>
                                ...
                                <table class="tableLayout">
                                    <asp:DataGrid ID="dgTimeRecord" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                        <Columns>
                                            <%--<asp:BoundColumn HeaderStyle-Width="10%" HeaderText="BIO NUMBER" DataField="bio_number" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>--%>
                                                <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee Name" DataField="fullName" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                ...
                                                <%--<asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TOTAL (hour/s)" DataField="TOTAL" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>--%>
                                                    ...
                                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TARDINESS (hour/s)" DataField="TARDINESSHOUR" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="MEMO POINT/S" DataField="MemoPoints" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        </Columns>
                                    </asp:DataGrid>
                                </table>
                                ...
                                <div class="pagination-container">
                                    <div class="pagination">
                                        <asp:Repeater ID="rptPaging" runat="server" OnItemCommand="rptPaging_ItemCommand">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkPageNumber" CommandName="Page" CommandArgument="<%# Container.DataItem %>" runat="server" ForeColor="Black" Font-Bold="True">
                                                    <%# Container.DataItem %>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <div class="pagination" onclick="selectPage()">
                                    ...
                                    <div class="card card-2 hidden">
                                        <div class="container-sm">
                                            ...
                                            <asp:Label ID="lblNoData" runat="server" CssClass="norecords" Text="No Pending Records Available" Visible="false"></asp:Label>
                                            <table class="tableLayout">
                                                <asp:DataGrid ID="dgPendingTimeAlteration" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                                    <Columns>
                                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DATE" DataField="DATE" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TYPE" DataField="timealteration_type" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TIME" DataField="timealteration_time" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="REASON" DataField="timealteration_reason" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                        <asp:TemplateColumn HeaderText="ACTION" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnCancel" runat="server" CssClass="btn-table btn-secondary" CommandArgument=<%# Eval( "timealteration_id") %> OnCommand="itemcommand">Cancel</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                                </asp:DataGrid>
                                ...
                                <!-- Modal Section -->
                                <!-- btnTimeAlteration -->
                                <div class="modal modal-time-alteration">
                                    <div class="modal-content">
                                        <!-- <span class="modal-close-btn" onclick="closeModal();"
                >&times;</span
              > -->
                                        <h5>Time Alteration Form</h5>
                                        <hr />
                                        <div class="">

                                            <label for="txtDate" class="label-6">Date: </label>
                                            <input name="txtDate" type="text" id="txtDate" class="datePicker" runat="server" />

                                            <div class="modal-chk-container">
                                                <label for="chkIn" class="label-6">
                                                    <input type="checkbox" name="chkInOut" id="chkIn" runat="server" /> In
                                                </label>

                                                <label for="chkOut" class="label-6">
                                                    <input type="checkbox" name="chkInOut" id="chkOut" runat="server" /> Out
                                                </label>
                                            </div>
                                            <!-- <label class="label-6">Time In</label>
                <input name="txtTimeIn" type="checkbox" id="txtTimeInNew"  class=""/>
                <label class="label-6">Time Out</label>
                <input name="txtTimeOut" type="checkbox" id="txtTimeOutNew"  class=""/> -->

                                            <label for="txtTime" class="label-6">Time</label>
                                            <input name="txtTime" type="text" id="txtTime" runat="server" />

                                            <label for="txtAreaReasonTA" class="label-6">Reason</label>
                                            <textarea name="txtAreaReasonTA" id="txtAreaReasonTA" runat="server"></textarea>
                                        </div>
                                        <div class="modal-btn-container">
                                            <a class="btn-sm btn-primary mx-3" id="btnAlterTime" runat="server" onserverclick="btnAlterTime_Click">Alter Time</a>
                                            <a class="btn-sm btn-secondary mx-3" onclick="closeModal(`#btnCloseTimeAlteration`);">Cancel</a>
                                        </div>
                                    </div>
                                </div>
