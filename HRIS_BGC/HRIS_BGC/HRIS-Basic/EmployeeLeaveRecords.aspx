<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeLeaveRecords.aspx.cs" Inherits="HRIS_Basic.EmployeeLeaveRecords" %>
        ...
        <form id="manageemployee" action="#" autocomplete="off" runat="server">
          ...
          <ul class="nav-list">
            ...
            <ul class="nav child_menu hidden">
              ...
              <li class="current-page"><a href="EmployeeLeaveRecords.aspx">Employee Leave Records</a></li>
          ...
          <div class="close-menu">
            ...
            <!-- Set Leave -->
            <section id="employee-leave-records" class="content">
                <!-- TOP NAV  -->
                <div class="top-nav">
                    <span class="menu-btn">
              <a href="#" onclick="toggleMenu()">
                ...
                <div class="container">
                    ...
                    <div class="card card-1">
                        <div class="">
                            <a class="btn-xs btn-alt" id="btnSetLeave" onclick="openModalSetLeave();">
                  Set Leave
                </a>
                        </div>
                        ...
                        <table class="tableLayout">
                            <asp:DataGrid ID="dgSetLeave" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow" ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout" CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Availabe Sick Leave" DataField="sick_leave" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Used Sick Leave" DataField="used_sickleave" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Available Vacation/Emergency Leave" DataField="vacation_leave" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Used Vacation/Emergency Leave" DataField="used_vacation_leave" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Year" DataField="leavecount_year" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                </Columns>
                            </asp:DataGrid>
                        </table>
                ...
                <!-- Modal Section -->
                <!-- btnFileLeave -->
                <div class="modal modal-set-leave">
                    <div class="modal-content">
                        <h5>Set Leave</h5>
                        <hr />
                        <div class="">
                            <label class="label-6 block">Employee</label>
                            <asp:DropDownList ID="drpEmployee" CssClass="select" runat="server">
                            </asp:DropDownList>

                            <label for="txtVacationLeave" class="label-6">Sick Leave: </label>
                            <input name="txtVacationLeave" id="txtSick" runat="server" />

                            <label for="txtVELeave" class="label-6">Vacation/Emergency Leave: </label>
                            <input name="txtVELeave" id="txtVacation" runat="server" />

                            <label for="drpYear" class="label-6">Year: </label>
                            <select name="drpYear" id="drpYear" class="select">
                            </select>

                            <div class="modal-btn-container">
                                <a class="btn-sm btn-primary mx-3" id="btnSet" runat="server" onserverclick="btnSet_Click">Set Leave</a>
                                <a class="btn-sm btn-secondary mx-3" onclick="closeModalSetLeave();">Cancel</a
                  >
                </div>
              </div>
            </div>
