<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payroll.aspx.cs" Inherits="HRIS_Basic.Payroll" %>
...
<body>
    ...
    <div class="main">
        ...
        <nav id="nav">
          ...
          <ul class="nav-list">
            <li class="current-page">
              <a href="Payroll.aspx"
                ><i class="fas fa-file-invoice"></i>Payroll</a
              >
            </li>
            <li>
              <a href="#"
                ><i class="fas fa-chart-area"></i>Reports<span
                  class="fa fa-chevron-down"
                ></span
              ></a>
              <ul class="nav child_menu hidden">
                <li>
                  <a href="UnderConstructionPayroll.aspx">Generate DTR Report</a>
                </li>
                <li>
                  <a href="UnderConstructionPayroll.aspx">Payroll Report</a>
                </li>
                <li>
                  <a href="UnderConstructionPayroll.aspx">Government Report</a>
                </li>
              </ul>
            </li>
            <li>
              <!-- <a href="memoannouncements.html" -->
              <a href="UnderConstructionPayroll.aspx"
                ><i class="far fa-bell"></i>Memo/Notice</a
              >
            </li>
            <li>
              <a href="UnderConstructionPayroll.aspx"
        ...
        <!-- Payroll -->
        <section id="payroll" class="content">
          <!-- TOP NAV  -->
          <div class="top-nav">
            <span class="menu-btn">
              <a href="#" onclick="toggleMenu()">
                <svg>
                  <path d="M0,5 30,5" str oke="#333" stroke-width="5" />
            ...
            <div id="tab">
              <ul class="tab-list" onclick="selectTab();">
                <li class="current-tab">
                  <a onclick="showP()">Payroll</a>
                </li>
                <li>
                  <a onclick="showPPA()">Pending Payroll Approval</a>
                </li>
              </ul>
            </div>
...
<a
                  ...
                  id="btnMassGeneratePayroll"
                  onclick="openModal(`#btnMassGeneratePayroll`)"
                >
                  Mass Generate Payroll
                </a>
                <a
                  class="btn-xs btn-alt"
                  id="btnCreatePayroll"
                  onclick="openModal(`#btnCreatePayroll`);"
                >
                  Create Payroll
                </a>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="txtDateFrom" type="text" id="txtDateFrom" class="startDatePicker hasDatepicker" />
                        <label for="txtDateTo" class="label-6">To: </label>
                        <input name="txtDateTo" type="text" id="txtDateTo" class="startDatePicker hasDatepicker" />
                        <button class="btn-sm btn-secondary">Clear</button>
                    </div>

                    <div>
                        <label for="showEmployeeBy" class="label-6 block">Show Employee by</label>
                        <asp:DropDownList ID="drpFormChoose" CssClass="select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpFormChoose_SelectedIndexChanged" required >
                        <asp:ListItem Value="0">Please Choose an Option</asp:ListItem>
                        <asp:ListItem Value="1">Department</asp:ListItem>
                        <asp:ListItem Value="2">Position</asp:ListItem>
                        </asp:DropDownList>
                        <asp:DropDownList ID="drpFormDepartment" CssClass="select" runat="server" Visible="false">
                        </asp:DropDownList>
                        <asp:DropDownList ID="drpFormPosition" CssClass="select" runat="server" Visible="false">
                        </asp:DropDownList>
                        <asp:DropDownList ID="DropDownList2" CssClass="select" runat="server" Visible="true">
                        </asp:DropDownList>
                    </div>
                    ...
                    <!-- Payroll -->
                     ...
                     <table class="tableLayout">
                                    <asp:DataGrid ID="dgPayroll" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        AutoGenerateColumns="False" OnItemDataBound="dgPayroll_ItemDataBound">
                                        <Columns>
                                         <asp:TemplateColumn HeaderStyle-Width="10%" HeaderText="" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                         <ItemTemplate>
                                         <asp:Label runat="server" Text='<%# Eval("Payroll_ID") %>' ID="lblPayrollID" Visible="false"></asp:Label>
                                         <asp:Label runat="server" Text='<%# Eval("Emp_ID") %>' ID="lblEmpID" Visible="false"></asp:Label>
                                         </ItemTemplate>
                                         </asp:TemplateColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Pay Period" DataField="PAYPERIOD"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee" DataField="Employee" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Position" DataField="Position_title"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Net Pay" DataField="NetPay"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            ...
                                            <ItemTemplate>
                                            <asp:Button ID="btnApprove" Width="35%" runat="server" Text="View Payslip" CommandArgument=<%# Eval("Payroll_ID") %>  OnCommand="itemcommand" />
                                            </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
            ...
            <div class="card card-2 hidden">
              ...
              <asp:Label ID="lblNoPending" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                     <table class="tableLayout">
                                    <asp:DataGrid ID="dgPendingPayroll" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout"
                                        CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center"
                                        AutoGenerateColumns="False" OnItemDataBound="dgPayroll_ItemDataBound">
                                        <Columns>
                                         ...
                                         <asp:Label runat="server" Text='<%# Eval("Emp_ID") %>' ID="lblEmpID" Visible="false"></asp:Label>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Net Pay" DataField="NetPay"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                                 <asp:TemplateColumn HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                            <asp:Button ID="btnDelete" Width="35%" runat="server" Text="Delete" CommandArgument=<%# Eval("Payroll_ID") %> OnCommand="itemcommanddelete"  CssClass="btn-table btn-secondary"/>
                                            </ItemTemplate>
                                            </asp:TemplateColumn>
                                        </Columns>
                                    </asp:DataGrid>
            ...
            <div class="modal modal-create-payroll">
                <div class="modal-content">
                    ...
                    <hr />
               <div>
                <label class="label-6 block">Pay Frequency</label>
                <select
                  name="drpDownPayFreqModal"
                  id="drpDownPayFreqModal"
                  class="select block drpDownPayFreq"
                  onchange="generatePayPeriod(`#drpDownPayFreqModal`,`#txtDateFromModal`,`#txtDateToModal`,`payroll`);"
                >
                  ...
                  <option value="custom">Custom</option>
                    ...
                    <div>
                        ...
                        <input name="txtDateFromModal" type="text" id="txtDateFromModal" class="datePickerPayroll" runat="server"/>                        
                        <label for="txtDateToModal" class="label-6">To: </label>
                        <input name="txtDateToModal" type="text" id="txtDateToModal" class="datePickerPayroll" runat="server"/>
                    </div>

                    <div>
                        <label for="showEmployeeByModal" class="label-6 block">Show Employee by</label>
                        <asp:DropDownList ID="drpChoose" CssClass="select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpChoose_SelectedIndexChanged" required >
                        <asp:ListItem Value="0">Please Choose an Option</asp:ListItem>
                        <asp:ListItem Value="1">Department</asp:ListItem>
                        <asp:ListItem Value="2">Position</asp:ListItem>
                        </asp:DropDownList>
                        <asp:DropDownList ID="drpEmployeeDepartment" CssClass="select" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="drpEmployeeDepartment_SelectedIndexChanged" required >
                        </asp:DropDownList>
                        <asp:DropDownList ID="drpEmployeePosition" CssClass="select" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="drpEmployeePosition_SelectedIndexChanged" required >
                        </asp:DropDownList>
                        <asp:DropDownList ID="DropDownList1" CssClass="select" runat="server" required >
                        </asp:DropDownList>
                    </div>
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="drpDownEmployee" required CssClass="select" runat="server" OnSelectedIndexChanged="drpDownEmployee_SelectedIndexChanged"
                                AutoPostBack="true">
                                </asp:DropDownList>
                  ...
                  <div class="modal-btn-container">
                    <a class="btn-sm btn-green mx-3" id="btnComputeModal" runat="server" onserverclick="btnComputeModal_Click"
                      >Compute</a
                    >
                    <a class="btn-sm btn-secondary mx-3" id="btnClearModal" onclick="reset(`payroll`)"
                      >Clear</a
                    >
                  </div>
                    ...
                    <div class="hidden">
                        <label class="label-6">With Deductions</label>
                        <div class="modal-rd-container">
                            <label for="opt1" class="radio">
                                <input type="radio" name="rdo" id="Radio1" class="hidden" />
                                <span class="label"></span>Yes
                            </label>

                            <label for="opt2" class="radio">
                                <input type="radio" name="rdo" id="Radio2" class="hidden" />
                  ...
                  <hr />
                  <div>
                    <label class="label-6">Basic Salary</label>
                    <p class="label-6" id="lblBasicSalary">0.00</p>
                  </div>
                  <hr />
                  
                  <div>
                    <div>
                      <label class="label-6">Total Hours</label>
                      <p class="label-6" id="lblTotalHours" runat="server">0.00</p>
                      <label class="label-6">Tardiness(minute)</label>
                      <p class="label-6" id="lblTardiness" runat="server">0.00</p>
                      <label class="label-6">Absent(hour)</label>
                      <p class="label-6" id="lblAbsent" runat="server">0.00</p>
                       <label class="label-6">Overtime</label>
                      <p class="label-6" id="lblOvertime" runat="server">0.00</p>
                       <label class="label-6">Leave</label>
                      <p class="label-6" id="P3" runat="server">0.00</p>                 
                    </div>

                    <div>
                      <label class="label-6">SSS/GSIS</label>
                      <p class="label-6" id="lblSssGsis" runat="server">0.00</p>
                      <label class="label-6">Pag-ibig</label>
                      <p class="label-6" id="lblPagibig" runat="server">0.00</p>
                      <label class="label-6">Philhealth</label>
                      <p class="label-6" id="lblPhilhealth" runat="server">0.00</p>
                      <label class="label-6">Other Deductions</label>
                      <p class="label-6" id="lblOtherDeduction" runat="server">0.00</p>
                      <label class="label-6">&nbsp</label>
                      <p id="P2" class="label-6"  runat="server">&nbsp</p>
                    </div>
                   </div>
              ...
              <div>
                ...
                <p class="label-6" id="lblGrossPay" runat="server">0.00</p>
                <label class="label-6">Net Pay</label>
                <p class="label-6" id="lblNetPay" runat="server">0.00</p>
              </div>
                    <hr />

                    <div class="modal-btn-container">

                        <a runat="server" ID="btnCreatePayrollModal" class="btn-sm btn-primary mx-3" onserverclick="btnCreatePayrollModal_Click">Create Payroll</a>
                        <a class="btn-sm btn-secondary mx-3" onserverclick="btnCloseModal_Click" runat="server">
                            Cancel
                        </a>
                    </div>
                </div>
          ...
          <!-- btnMassGeneratePayroll -->
          <div class="modal modal-mass-payroll">
            <div class="modal-content">
              <h5>Generate Payroll</h5>
              <hr />
              <div>
                <label class="label-6 block">Pay Frequency</label>
                <select
                  name="drpDownPayFreqModal2"
                  id="drpDownPayFreqModal2"
                  class="select block drpDownPayFreq"
                  onchange="generatePayPeriod(`#drpDownPayFreqModal2`,`#txtDateFromModal2`,`#txtDateToModal2`,`payroll`);"
                >
                  <option value="">--Please choose an option--</option>
                  <option value="weekly">Weekly</option>
                  <option value="twoWeeks">Every 2 weeks</option>
              ...
              <div>
                <label class="label-6 block">Pay Period</label>
                <label for="txtDateFromModal2" class="label-6">From: </label>
                <input
                  name="txtDateFromModal2"
                  type="text"
                  id="txtDateFromModal2"
                  class="startDatePicker"
                  runat="server"
                  onchange="generatePayPeriod(`#drpDownPayFreqModal2`,`#txtDateFromModal2`,`#txtDateToModal2`,`payroll`);"
                />
                <label for="txtDateToModal2" class="label-6">To: </label>
                <input
                  name="txtDateToModal2"
                  type="text"
                  id="txtDateToModal2"
                  class="endDatePicker disabled"
                  runat="server"
                  onchange="generatePayPeriod(`#drpDownPayFreqModal2`,`#txtDateFromModal2`,`#txtDateToModal2`,`payroll`);"
                />
              </div>
              ...
              <div>
                <label for="showEmployeeByCategoryModal2" class="label-6 block"
                  >Select Department</label
                >
                <asp:DropDownList ID="drpDepartmentMass" CssClass="select" runat="server" required >
                 </asp:DropDownList>
              </div>
              ...
              <div class="modal-btn-container">
                <a class="btn-sm btn-green mx-3" id="btnMassCompute" runat="server" onserverclick="btnMassCompute_Click"
                  >Compute</a
                >
                <a
                  class="btn-sm btn-secondary mx-3"
                  id="btnClearModal2"
                  onclick="reset(`payroll`)"
                  >Clear</a
                >
              </div>
              ...
              <div class="hidden">
                ...
                >
                <input type="" value="" id="1" />
              </div>

              <table class="tableLayout">
                                    <asp:DataGrid ID="dgMassPayroll" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ItemStyle-CssClass="MainTableRow" HeaderStyle-CssClass="MainTableRow" CssClass="tableLayout"
                                        CellSpacing="1" CellPadding="3" Width="100%" BorderWidth="0" HorizontalAlign="Center"
                                        AutoGenerateColumns="False">
                                        <Columns>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee" DataField="FullName"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="DEPARTMENT" DataField="department" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="TOTAL EARNINGS" DataField="GrossPay"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                            <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="NET PAY" DataField="NetPay"
                                                HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                                        </Columns>
              ...
              <div class="modal-btn-container">
                <a class="btn-sm btn-primary mx-3" id="btnMassGenerate" runat="server" onserverclick="btnMassGenerate_Click">
                  Mass Generate
                </a>
                <a
                  class="btn-sm btn-secondary mx-3"
                  onclick="closeModal(`#btnCloseMassPayroll`);"
                >
                  Cancel
                </a>
              </div>
