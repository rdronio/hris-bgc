<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="HRIS_Basic.LoginPage" %>
    ...
    <body>
        ...
        <section id="login">
            ...
            <div class="left-container">
                <div class="logo">
                    <p>Logo - Time Keeping System w/ Leave Records</p>
                </div>

                <h2>Sign in</h2>
               
                <label id="lblInvalid" class="notif notif-red hidden" runat="server"
                  >Invalid Username or Password.</label
                >
                <label id="lblChangePassword" class="notif notif-red hidden" runat="server"
                  >Please change your password. Click&nbsp;<a runat="server" id="btnClickHere" onserverclick="btnClickHere_Click"><u>here.</u></a></label>
                <label for="txtUsername">Username</label>
                <input type="text" id="txtUsername" runat="server" autofocus required />
                <div class="pass-container">
                    <label for="txtPass">Password</label>
                    <a href="#" class="forgotPass">Forgot your password?</a>
                </div>
                <input type="password" id="txtPass" runat="server" />
                <div class="showPass-container">
                    <input type="checkbox" name="showPass" id="showPass" runat="server" onclick="togglePassword();" />
                    <label for="showPass" class="showPass">Show Password</label>
                </div>

                <button id="btnSignIn" runat="server" onserverclick="btnSignIn_Click" class="btn btn-primary">Sign In</button>
