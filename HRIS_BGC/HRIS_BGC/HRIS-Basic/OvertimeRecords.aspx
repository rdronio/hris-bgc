                    ...
                    <asp:Label ID="lblNoRecords" runat="server" CssClass="norecords" Text="No Records Available" Visible="false"></asp:Label>
                     <table class="tableLayout">
                                    <asp:DataGrid ID="dgOvertimeRecord" runat="server" AlternatingItemStyle-CssClass="AlternateMainTableRow"
                                        ...
                                        <Columns>
                                        <asp:BoundColumn HeaderStyle-Width="10%" HeaderText="Employee Name" DataField="Employee"
            ...
            <div class="modal modal-overtime-application">
                <div class="modal-content">
                    ...
                    <asp:DropDownList ID="drpEmployee" CssClass="select" runat="server" required >
                        ...
                        <label for="txtDateOT" class="label-6">No. of Hour/s </label>
                        <input name="txtDateOT" type="text" id="txtHours" runat="server" />
